(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.KoinosPbToProto = {}));
  ...
  */
  ...
  googleProtobuf.Map;
  googleProtobuf.Message;
  googleProtobuf.BinaryReader;
  googleProtobuf.BinaryWriter;
  googleProtobuf.ExtensionFieldInfo;
  googleProtobuf.ExtensionFieldBinaryInfo;
  googleProtobuf.exportSymbol;
  googleProtobuf.inherits;
  googleProtobuf.object;
  googleProtobuf.typeOf;
  ...
  */
  ...
  var options_pb = createCommonjsModule(function (module, exports) {
   ...
   */
  proto.koinos.btype = new googleProtobuf.ExtensionFieldInfo(50000, { btype: 0 }, null, 
  /** @type {?function((boolean|undefined),!jspb.Message=): !Object} */ (null), 0);
  descriptor_pb.FieldOptions.extensionsBinary[50000] = new googleProtobuf.ExtensionFieldBinaryInfo(proto.koinos.btype, googleProtobuf.BinaryReader.prototype.readEnum, googleProtobuf.BinaryWriter.prototype.writeEnum, undefined, undefined, false);
  // This registers the extension field with the extended class, so that
  // toObject() will function correctly.
  descriptor_pb.FieldOptions.extensions[50000] = proto.koinos.btype;
  ...
  const optionspb = __importStar(options_pb);
  ...
  function getJSType(options) {
      ...
      switch (options.getJstype()) {
          case descriptor_pb.FieldOptions.JSType.JS_NORMAL:
              return '';
          case descriptor_pb.FieldOptions.JSType.JS_NUMBER:
              return 'jstype = JS_NUMBER';
          case descriptor_pb.FieldOptions.JSType.JS_STRING:
  ...
  function getFieldLabel(fieldDesc) {
      switch (fieldDesc.getLabel()) {
          case descriptor_pb.FieldDescriptorProto.Label.LABEL_REPEATED:
              return 'repeated';
          case descriptor_pb.FieldDescriptorProto.Label.LABEL_REQUIRED:
              return 'required';
          case descriptor_pb.FieldDescriptorProto.Label.LABEL_OPTIONAL:
  ...
  const convert = (pb) => {
      ...
      const fds = descriptor_pb.FileDescriptorSet.deserializeBinary(input);
      ...
      for (const fd of fds.getFileList()) {
          ...
          // syntax
          if (fd.hasSyntax()) {
              definition += (0, util.getSyntax)(fd);
          }
          // package
          if (fd.hasPackage()) {
              definition += (0, util.getPackage)(fd);
          }
          // options
          if (fd.hasOptions()) ;
          // imports
          for (const dep of fd.getDependencyList()) {
              definition += (0, util.getImport)(dep);
          }
          // enums
          for (const enumDesc of fd.getEnumTypeList()) {
              definition += (0, util.getEnum)(enumDesc);
          }
          // extensions
          for (const extDesc of fd.getExtensionList()) {
              definition += (0, util.getExtension)(extDesc);
          }
          // messages
          for (const messageDesc of fd.getMessageTypeList()) {
              definition += (0, util.getMessage)(messageDesc);
          }
  ...
  var lib_1 = lib.convert;

  exports.convert = lib_1;
